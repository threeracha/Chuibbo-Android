...
public class HomeJobPostingRecyclerViewAdapter extends RecyclerView.Adapter<HomeJobPostingRecyclerViewAdapter.ViewHolder> {
    private Context context;
    private ArrayList<JobPostingModel> mData;
    private LayoutInflater mInflater;

    // data is passed into the constructor
    HomeJobPostingRecyclerViewAdapter(Context context, ArrayList<JobPostingModel> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.home_job_posting, parent, false);
    ...
    JobPostingModel getItem(int id) {
        return mData.get(id);
    }
}