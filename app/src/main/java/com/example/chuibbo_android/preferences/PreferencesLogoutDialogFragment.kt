...
class PreferencesLogoutDialogFragment: DialogFragment() {
    ...
    override fun onCreateView(
        ...
        var view: View = inflater.inflate(R.layout.preferences_logout_dialog_fragment, container, false)

        var fragment: Fragment? = activity?.supportFragmentManager?.findFragmentByTag("Logout")
